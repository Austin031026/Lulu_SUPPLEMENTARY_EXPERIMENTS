...
def test_package_paths_do_not_import_torch():
    script = (
        f'import sys; sys.path.insert(0, {str(ROOT)!r}); '
        'from lulu.paths import PROJECT_ROOT, DEFAULT_BENCHMARK_PARSER; '
        f'assert str(PROJECT_ROOT) == {str(ROOT)!r}; '
        'assert DEFAULT_BENCHMARK_PARSER == PROJECT_ROOT / "lulu" / "benchmark_parser.py"; '
